...
app.get("/", (req, res) => {
  res.render("index.ejs", {yearNum : year});
});

app.post("/submit", (req, res) => {
  const ranAdjIndex = Math.floor(Math.random() * adj.length);
  const ranNounIndex = Math.floor(Math.random() * noun.length);
  const ranName = adj[ranAdjIndex] + " " + noun[ranNounIndex];
  res.render("index.ejs", {bandName : ranName, yearNum : year});
